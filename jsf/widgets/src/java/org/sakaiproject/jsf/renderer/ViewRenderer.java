...
public class ViewRenderer extends Renderer
{
	...
	public void encodeBegin(FacesContext context, UIComponent component) throws IOException
	{
		...
		if (!renderAsFragment(context))
		{
			...
			writer.write("<script type=\"text/javascript\" src=\"/e3/support/jquery-1.8.2.min.js\"></script>");
			writer.write("<script type=\"text/javascript\" src=\"/e3/support/jquery-ui-1.8.24.custom.min.js\"></script>");
			writer.write("<script type=\"text/javascript\" src=\"/e3/support/etudesDnd.js\"></script>");
			writer.write("</head>\n");
