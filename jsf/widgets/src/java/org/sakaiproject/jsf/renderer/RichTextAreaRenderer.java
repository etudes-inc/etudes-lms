/**********************************************************************************
* $URL: https://source.etudes.org/svn/etudes/source/trunk/jsf/widgets/src/java/org/sakaiproject/jsf/renderer/RichTextAreaRenderer.java $
* $Id: RichTextAreaRenderer.java 5580 2013-08-09 17:39:01Z rashmim $
***********************************************************************************
*
...
public class RichTextAreaRenderer extends Renderer
{
            ...
            throws IOException
    {
        ...
        RendererUtil.writeExternalJSDependencies(context, writer, "richtextarea.jsf.ckeditor.js", ServerConfigurationService.getString("etudes.editor.path")+"/ckeditor/ckeditor.js");
        RendererUtil.writeExternalJSDependencies(context, writer, "richtextarea.jsf.ckeditorlaunch.js", ServerConfigurationService.getString("etudes.editor.path")+"/ckeditor.launch.js");
        ...
        writer.write(">");
        if (value != null)
           writer.write(Validator.escapeHtmlTextarea((String) value));
