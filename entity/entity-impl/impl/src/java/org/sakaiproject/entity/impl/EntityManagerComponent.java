/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/entity/entity-impl/impl/src/java/org/sakaiproject/entity/impl/EntityManagerComponent.java $
 * $Id: EntityManagerComponent.java 8212 2014-06-09 08:05:14Z mallikamt $
 ***********************************************************************************
 *
...
public class EntityManagerComponent implements EntityManager
{
	 ...
	 * @inheritDoc
	 */
	public boolean checkReference(String ref, String invalidCharSet)
	{
		// the rules:
		//	Null is rejected
		//	all blank is rejected
		...
		for (int i = 0; i < id.length(); i++)
		{
			if (invalidCharSet.indexOf(id.charAt(i)) != -1)
				return false;
		}
