/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/entity/entity-api/api/src/java/org/sakaiproject/entity/cover/EntityManager.java $
 * $Id: EntityManager.java 8212 2014-06-09 08:05:14Z mallikamt $
 ***********************************************************************************
 *
...
public class EntityManager
{
	...
	public static boolean checkReference(java.lang.String param0, java.lang.String param1)
	{
		org.sakaiproject.entity.api.EntityManager service = getInstance();
		if (service == null) return false;

		return service.checkReference(param0, param1);
	}
}
