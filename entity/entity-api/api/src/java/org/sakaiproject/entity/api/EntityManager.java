/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/entity/entity-api/api/src/java/org/sakaiproject/entity/api/EntityManager.java $
...
public interface EntityManager
{
	...
	/**
	 * Check for a valid reference using the character set.
	 * 
	 * @param ref
	 *        a reference string.
	 ...
	 * @return true if the reference is valid, false if not.
	 */
	boolean checkReference(String ref, String invalidCharSet);
