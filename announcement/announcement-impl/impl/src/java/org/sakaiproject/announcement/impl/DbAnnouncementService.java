/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/announcement/announcement-impl/impl/src/java/org/sakaiproject/announcement/impl/DbAnnouncementService.java $
 * $Id: DbAnnouncementService.java 8101 2014-06-03 01:03:11Z mallikamt $
 ***********************************************************************************
 *
...
public class DbAnnouncementService extends BaseAnnouncementService
{
	...
	protected class DbStorage extends BaseDbDoubleStorage implements Storage
	{
		...
		{
			return super.getContainersMatching(context);
		}
		...
		{
			return (MessageChannelEdit) super.updateContainer(ref, newRef, context);
		}
		...
		{
			return (MessageEdit) super.updateResourceContainer(channel, id, newRef);
		}
