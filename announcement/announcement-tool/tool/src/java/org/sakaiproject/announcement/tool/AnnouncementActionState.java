/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/announcement/announcement-tool/tool/src/java/org/sakaiproject/announcement/tool/AnnouncementActionState.java $
 * $Id: AnnouncementActionState.java 12190 2015-12-02 20:20:14Z mallikamt $
 ***********************************************************************************
 *
...
public class AnnouncementActionState extends ControllerState implements SessionBindingListener
{
	...
	// the list of messages to be archived
	private Vector m_archive_messages = new Vector();
	 ...
	 * Get
	 */
	public Vector getArchive_messages()
	{
		return m_archive_messages;
	 ...
	 * Set
	 */
	public void setArchiveMessages(Vector archive_messages)
	{
		// if there's a change
		if (archive_messages != null)
		{
			m_archive_messages = (Vector) archive_messages.clone();
		}
		else
		{
			m_archive_messages = null;
		}
		// remember the new
