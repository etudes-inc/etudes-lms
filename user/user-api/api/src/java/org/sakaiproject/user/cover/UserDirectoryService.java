/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/user/user-api/api/src/java/org/sakaiproject/user/cover/UserDirectoryService.java $
...
public class UserDirectoryService
{
	...
	public static java.util.List<org.sakaiproject.user.api.User> getUsersByEid(java.lang.String param0)
	{
		org.sakaiproject.user.api.UserDirectoryService service = getInstance();
		if (service == null) return null;

		return service.getUsersByEid(param0);
	}

	public static User getUserByIid(java.lang.String param0, java.lang.String param1) throws org.sakaiproject.user.api.UserNotDefinedException
	{
		org.sakaiproject.user.api.UserDirectoryService service = getInstance();
		if (service == null) return null;

		return service.getUserByIid(param0, param1);
	}

	public static void setIid(java.lang.String param0, java.lang.String param1, java.lang.String param2)
			throws org.sakaiproject.user.api.UserPermissionException
	{
		org.sakaiproject.user.api.UserDirectoryService service = getInstance();
		if (service == null) return;

		service.setIid(param0, param1, param2);
	}

	public static void clearIid(java.lang.String param0) throws org.sakaiproject.user.api.UserPermissionException
	{
		org.sakaiproject.user.api.UserDirectoryService service = getInstance();
		if (service == null) return;

		service.clearIid(param0);
	}

	public static java.util.List<java.lang.String> getIid(java.lang.String param0)
	{
		org.sakaiproject.user.api.UserDirectoryService service = getInstance();
		if (service == null) return null;

		return service.getIid(param0);
	}

	public static boolean hasIid(java.lang.String param0)
	{
		org.sakaiproject.user.api.UserDirectoryService service = getInstance();
		if (service == null) return false;

		return service.hasIid(param0);
	}
	...
	public static org.sakaiproject.user.api.User addUser(java.lang.String param0, java.lang.String param1, java.lang.String param2,
			...
			org.sakaiproject.entity.api.ResourceProperties param7)
			throws org.sakaiproject.user.api.UserIdInvalidException, org.sakaiproject.user.api.UserAlreadyDefinedException,
			org.sakaiproject.user.api.UserPermissionException
	{
		org.sakaiproject.user.api.UserDirectoryService service = getInstance();
	...
	public static org.sakaiproject.user.api.User authenticate(java.lang.String param0, java.lang.String param1) throws org.sakaiproject.user.api.AuthenticationException
	{
		org.sakaiproject.user.api.UserDirectoryService service = getInstance();
		if (service == null) return null;
