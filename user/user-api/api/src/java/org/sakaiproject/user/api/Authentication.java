/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/user/user-api/api/src/java/org/sakaiproject/user/api/Authentication.java $
...
public interface Authentication
{
	...
	/**
	 * @return TRUE if the user's authenticated password is a strong password, FALSE if not.
	 */
	Boolean getPasswordStrength();
}
