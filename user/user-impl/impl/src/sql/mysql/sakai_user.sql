...
CREATE INDEX AK_SAKAI_USER_ID_MAP_EID ON SAKAI_USER_ID_MAP
(
       EID                       ASC
);

-----------------------------------------------------------------------------
-- IID mapping - many to one user
-----------------------------------------------------------------------------

CREATE TABLE SAKAI_USER_IID
(
       ID                  BIGINT UNSIGNED AUTO_INCREMENT NOT NULL PRIMARY KEY,
       USER_ID             VARCHAR (99) NOT NULL,
       IID                 VARCHAR (99) NOT NULL,
       INST_CODE           VARCHAR (12) NOT NULL
);

CREATE UNIQUE INDEX AK_SAKAI_USER_IID ON SAKAI_USER_IID
(
       IID                 ASC,
       INST_CODE           ASC
);

CREATE INDEX AK_SAKAI_USER_IID_UID ON SAKAI_USER_IID
(
       USER_ID             ASC
);
