/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/user/user-impl/impl/src/java/org/sakaiproject/user/impl/OpenAuthnComponent.java $
 * $Id: OpenAuthnComponent.java 5592 2013-08-13 02:58:43Z ggolden $
 ***********************************************************************************
 *
...
public class OpenAuthnComponent implements AuthenticationManager
{
	...
	public Authentication authenticate(Evidence e) throws AuthenticationException
	{
		if (e instanceof IdPwEvidence)
		{
			...
			Authentication rv = new org.sakaiproject.util.Authentication(evidence.getPassword(), evidence.getIdentifier(), Boolean.FALSE);
			return rv;
		}
		else if (e instanceof ExternalTrustedEvidence)
		{
			...
			Authentication rv = new org.sakaiproject.util.Authentication("000-00-0000", evidence.getIdentifier(), Boolean.FALSE);
			return rv;
		}
		else
		{
