/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/component/component-api/component/src/java/org/sakaiproject/component/api/ComponentManager.java $
 * $Id: ComponentManager.java 5128 2013-06-08 00:42:09Z ggolden $
 ***********************************************************************************
 *
...
public interface ComponentManager
{
	...
	/**
	 * Run the runnable once the component that provides this interface is registered - now or later.
	 * 
	 * @param iface
	 *        The interface Class.
	 * @param run
	 *        The runnable to run.
	 */
	void whenAvailable(Class iface, Runnable run);
