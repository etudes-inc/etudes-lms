/**********************************************************************************
*
* $Id: GradebookService.java 9580 2014-12-18 03:31:53Z ggolden $
*
***********************************************************************************
*
...
public interface GradebookService {
	...
	/**
	 * Transfers Gradebook options settings from source site to destination site
	 * @param fromContext Site id of source site
	 * @param toContext Site id of destination site
	...
	/**
	 * Create the internal assignment in the gradebook
	 *  
	 * @param gradebookUid		Gradebook id
	 * @param name				Name of the assignment
	 * @param points			Points
	 * @param dueDate			Due date
	 * @param isNotCounted		Is assignment counted in grading
	 * @param isReleased		Is assignemnt released
	 * @return					Created Assigment id
	 * @throws ConflictingAssignmentNameException
	 * @throws ConflictingAssignmentNameException
	 */
	public Long createAssignment(String gradebookUid, String name, Double points, Date dueDate, Boolean isNotCounted, Boolean isReleased) throws GradebookNotFoundException, ConflictingAssignmentNameException;
	...
	/**
	 * Gets the earliest due date of all the manually entered assignments in the gradebook
	 * @param gradebookUid	gradebook id
	 * @return If due date exists for the manually entered assignments gets the earliest due date else returns null
	 */
	public Date getInternalAssignmentsMinDueDate(String gradebookUid);
	
	/**
	 * Gets the latest due date of all the manually entered assignments in the gradebook
	 * @param gradebookUid	gradebook id
	 * @return If due date exists for the manually entered assignments gets the latest due date else returns null
	 */
	public Date getInternalAssignmentsMaxDueDate(String gradebookUid);
	
	
	/**
	 * Apply base date to all due dates of manually entered assignments in the gradebook
	 * @param course_id		Course id
	 * @param days_diff		Time difference in days
	 */
	void applyBaseDateTx(String course_id, int days_diff);

	void removeAssessment(String gradebookUid, String name) throws GradebookNotFoundException, AssessmentNotFoundException;
}
