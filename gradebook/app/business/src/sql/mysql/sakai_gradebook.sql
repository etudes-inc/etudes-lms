...
alter table gb_gradebook_t add TODATE_GRADE_DISPLAYED bit not null default 1;
alter table gb_gradebook_t add TODATE_POINTS_DISPLAYED bit not null default 1;
