/**********************************************************************************
*
* $Id: OverviewBean.java 64 2008-10-21 16:14:28Z ggolden $
*
***********************************************************************************
*
...
public class OverviewBean extends GradebookDependentBean implements Serializable  {
    ...
    private GradableObject courseGradeObject;
	...
	public GradableObject getCourseGradeObject() {
		return courseGradeObject;
	}
	
	public void setCourseGradeObject(GradableObject courseGradeObject) {
		this.courseGradeObject = courseGradeObject;
	}
	...
	protected void init() {
        ...
        gradableObjects = getGradebookManager().getAssignmentsAndCourseGradeWithStats(getGradebookId(),
        	...
        	setCourseGradeObject((GradableObject)gradableObjects.get(gradableObjects.size()-1));
	}
