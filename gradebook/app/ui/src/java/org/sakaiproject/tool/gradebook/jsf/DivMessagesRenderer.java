/**********************************************************************************
*
* $Id: DivMessagesRenderer.java 3 2008-10-20 18:44:42Z ggolden $
*
***********************************************************************************
*
 ...
 *			<renderer-class>org.sakaiproject.tool.gradebook.jsf.DivMessagesRenderer</renderer-class>
 *		</renderer>
 *	</render-kit>
 *
...
public class DivMessagesRenderer extends DivMessageRendererBase {
    ...
    private List combineMessages(FacesContext context, UIComponent component) {
        List redirectSafeMessages = ((MessagingBean)FacesUtil.resolveVariable("messagingBean")).getMessagesAndClear();
        ...
        if(globalOnly && redirectSafeMessages.size() == 0 && !globalFacesMessages.hasNext() && componentBoundMessages.size() != 0) {
            FacesMessage seeBelowMessage = new FacesMessage(FacesMessage.SEVERITY_WARN, FacesUtil.getLocalizedString(context, "validation_messages_present"), null);
