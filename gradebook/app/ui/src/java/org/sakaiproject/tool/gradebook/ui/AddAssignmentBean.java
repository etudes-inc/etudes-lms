/**********************************************************************************
*
* $Id: AddAssignmentBean.java 9580 2014-12-18 03:31:53Z ggolden $
*
***********************************************************************************
*
...
public class AddAssignmentBean extends GradebookDependentBean implements Serializable {
	...
	public Boolean getAssignmentsDisabled()
	{
		Long termId = SiteService.getSiteTermId(ToolManager.getCurrentPlacement().getContext());
		
		
		// for terms before or in F14 (7..42), not disabled
		if ((termId != null) && (termId >= 7) && (termId <= 42)) return Boolean.FALSE;
