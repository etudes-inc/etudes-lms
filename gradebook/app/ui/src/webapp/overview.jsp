  ...
  <div class="portletBody">
	<h:form id="gbForm">
	  ...
	  <sakai:flowState bean="#{overviewBean}" />
		...
		<%
		/*
		// 06/14/2010 commented by Murthy
		<!-- Course grade link -->
		<h:commandLink action="courseGradeDetails" rendered="#{overviewBean.courseGradeObject.courseGrade}"  styleClass="toolUiLink">
			<h:outputText value="#{overviewBean.courseGradeObject.name}" />
		</h:commandLink>
		*/
		%>
		...
		<div class="instruction">
			...
			<h:panelGroup rendered="#{overviewBean.userAbleToEditAssessments}">
				...
				<h:commandLink action="feedbackOptions" immediate="true" styleClass="toolUiLinkU">
		...
		<x:dataTable cellpadding="0" cellspacing="0"
			...
			<h:column>
				...
				<h:commandLink action="assignmentDetails" rendered="#{!gradableObject.courseGrade}" styleClass="toolUiLink">
