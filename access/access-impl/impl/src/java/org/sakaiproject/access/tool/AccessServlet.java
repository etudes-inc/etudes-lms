/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/access/access-impl/impl/src/java/org/sakaiproject/access/tool/AccessServlet.java $
 * $Id: AccessServlet.java 4893 2013-05-20 20:54:50Z ggolden $
 ***********************************************************************************
 *
...
public class AccessServlet extends VmServlet
{
	...
	public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
	{
		...
		if ((parts.length == 2) && ((parts[1].endsWith("login"))))
		{
			doLogin(req, res, null, parts[1]);
		}	
		else
		{
			dispatch(req, res);
	...
	public void dispatch(HttpServletRequest req, HttpServletResponse res) throws ServletException
	{
		...
		catch (EntityPermissionException e)
		{
			...
			{
				try {
					doLogin(req, res, origPath, "/login");
	 ...
	 * @throws IOException 
	 */
	protected void doLogin(HttpServletRequest req, HttpServletResponse res, String path, String loginOption) throws ToolException, IOException
	{
		...
		String context = req.getContextPath() + req.getServletPath() + "/" + loginOption;
		tool.help(req, res, context, "/" + loginOption);
	}
