/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/reference/library/src/webapp/js/chatscript.js $
 * $Id: chatscript.js 7831 2014-04-21 20:06:39Z ggolden $
 ***********************************************************************************
 *
...
function appendMessage(uname, uid, removeable, pdate, ptime, msg, msgId)
{
	...
	var transcript = document.getElementById("chatList");
