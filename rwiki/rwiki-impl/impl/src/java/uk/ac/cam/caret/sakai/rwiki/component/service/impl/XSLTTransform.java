/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/rwiki/rwiki-impl/impl/src/java/uk/ac/cam/caret/sakai/rwiki/component/service/impl/XSLTTransform.java $
 * $Id: XSLTTransform.java 7547 2014-03-07 17:58:31Z mallikamt $
 ***********************************************************************************
 *
...
public class XSLTTransform
{
	...
	public void setXslt(InputSource xsltresource) throws Exception
	{
		...
		xr.setFeature(EXTERNAL_GENERAL_ENTITIES_ID, false); 
		xr.setFeature(DISALLOW_DOCTYPE_DECL_ID, true);
