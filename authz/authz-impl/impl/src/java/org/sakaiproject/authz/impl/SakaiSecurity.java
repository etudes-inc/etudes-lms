/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/authz/authz-impl/impl/src/java/org/sakaiproject/authz/impl/SakaiSecurity.java $
 * $Id: SakaiSecurity.java 8045 2014-05-29 22:14:42Z ggolden $
 ***********************************************************************************
 *
...
public abstract class SakaiSecurity implements SecurityService
{
	...
	public boolean unlock(String userId, String function, String entityRef, Collection azgs)
	{
		...
		if (function == null || entityRef == null)
		{
			M_log.warn("unlock(): null: " + function + " " + entityRef);
			return false;
		}
