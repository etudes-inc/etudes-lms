/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/authz/authz-api/api/src/java/org/sakaiproject/authz/api/AuthzGroup.java $
 * $Id: AuthzGroup.java 1112 2011-01-29 01:08:22Z ggolden $
 ***********************************************************************************
 *
...
public interface AuthzGroup extends Edit, Comparable, Serializable
{
	...
	/**
	 * Access all Membership records defined for this AuthzGroup that are active and have basic permission ("site.visit").
	 * 
	 * @return The qualified set of Membership records (Membership) defined for this AuthzGroup.
	 */
