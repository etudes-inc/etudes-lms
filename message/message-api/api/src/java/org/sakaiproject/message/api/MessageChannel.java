/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/message/message-api/api/src/java/org/sakaiproject/message/api/MessageChannel.java $
 * $Id: MessageChannel.java 8048 2014-05-30 00:01:56Z mallikamt $
 ***********************************************************************************
 *
...
public interface MessageChannel extends Entity
{
	 ...
	 *            If the user does not have write permission to the channel.
	 */
	MessageEdit updateMessage(String id, String newRef) throws PermissionException;
	...
	/**
	 * Get the collection of Groups defined for the context of this channel that the end user has the specified permission in.
	 * 
	 * @param permission
	 *        The permission.
	 *        
	 * @return The Collection (Group) of groups defined for the context of this channel that the end user has add message permissions in, empty if none.
	 */
	Collection getGroupsAllowAddMessage(String permission);
	...
	/**
	 * Get the collection of Group defined for the context of this channel that the end user has get room permissions in.
	 * 
	 * @return The Collection (Group) of groups defined for the context of this channel that the end user has get room permissions in, empty if none.
	 */
	Collection getGroupsAllowGetRooms();
