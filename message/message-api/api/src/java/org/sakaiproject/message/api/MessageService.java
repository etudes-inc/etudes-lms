/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/message/message-api/api/src/java/org/sakaiproject/message/api/MessageService.java $
 * $Id: MessageService.java 8282 2014-06-18 18:32:02Z mallikamt $
 ***********************************************************************************
 *
...
public interface MessageService extends EntityProducer
{
	...
	/** These characters are not allowed in a channel id */
	public static final String INVALID_CHARS_IN_CHANNEL_ID = "^'/\\{}[]%*?#&=\n\r\t\b\f";
