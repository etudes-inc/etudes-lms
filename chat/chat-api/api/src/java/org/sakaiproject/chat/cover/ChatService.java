/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/chat/chat-api/api/src/java/org/sakaiproject/chat/cover/ChatService.java $
 * $Id: ChatService.java 8258 2014-06-13 22:11:21Z mallikamt $
 ***********************************************************************************
 *
...
public class ChatService
{
	...
	public static java.lang.String SECURE_UPDATE = org.sakaiproject.chat.api.ChatService.SECURE_UPDATE;
	...
	public static org.sakaiproject.chat.api.ChatChannelEdit updateChatChannel(java.lang.String param0, java.lang.String param1)
	throws org.sakaiproject.exception.IdUsedException, org.sakaiproject.exception.IdInvalidException,
	org.sakaiproject.exception.PermissionException
	{
		org.sakaiproject.chat.api.ChatService service = getInstance();
		...
		return service.updateChatChannel(param0, param1);
	}

	public static boolean checkPositions(List chatList)
	{
		org.sakaiproject.chat.api.ChatService service = getInstance();
		if (service == null) return false;

		return service.checkPositions(chatList);
	}
	
	public static void populatePositions(java.lang.String param0, java.lang.String param1)
	{
		org.sakaiproject.chat.api.ChatService service = getInstance();
		if (service == null) return;

		service.populatePositions(param0, param1);
	}
	
	public static int getMaxPosition(List chatList)
	{
		org.sakaiproject.chat.api.ChatService service = getInstance();
		if (service == null) return 0;

		return service.getMaxPosition(chatList);
	}
	
	public static java.util.List sortByPosition(List chatList)
	{
		org.sakaiproject.chat.api.ChatService service = getInstance();
		if (service == null) return null;

		return service.sortByPosition(chatList);
	}
	...
	public static java.util.List getChannels(java.lang.String param0)
	{
		org.sakaiproject.chat.api.ChatService service = getInstance();
		if (service == null) return null;

		return service.getChannels(param0);
	}
	...
	public static java.lang.String extractChannelId(java.lang.String param0)
	{
		org.sakaiproject.chat.api.ChatService service = getInstance();
		if (service == null) return null;

		return service.extractChannelId(param0);
	}
