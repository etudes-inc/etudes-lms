/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/chat/chat-impl/impl/src/java/org/sakaiproject/chat/impl/DbChatService.java $
 * $Id: DbChatService.java 8101 2014-06-03 01:03:11Z mallikamt $
 ***********************************************************************************
 *
...
public class DbChatService extends BaseChatService
{
	...
	protected class DbStorage extends BaseDbDoubleStorage implements Storage
	{
		...
		{
			return super.getContainersMatching(root);
		}
