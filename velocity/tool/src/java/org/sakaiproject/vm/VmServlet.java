/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/velocity/tool/src/java/org/sakaiproject/vm/VmServlet.java $
 * $Id: VmServlet.java 8290 2014-06-20 05:47:45Z ggolden $
 ***********************************************************************************
 *
...
public abstract class VmServlet extends ComponentServlet
{
	...
	protected void includeVm(String template, HttpServletRequest request, HttpServletResponse response) throws ServletException
	{
		...
		catch (IOException e)
		{
			...
			{
				// the user broke the connection - we can ignore
			}
			else
			{
