...
function calendar2(obj_target,hrs,mins,ampm) {
	...
	// Adding these to set times for publish and unpublish dates differently (SAK-301)
	this.sethrs = hrs;
	this.setmins = mins;
	this.ampm = ampm;
}
...
function cal_popup2 (str_datetime) {
    ...
    var obj_calwindow = window.open(
		'/sakai-site-manage-tool/calendar/calendar.html?datetime=' + this.dt_current.valueOf()+ '&ampmval=' + this.ampm_val +
		'&id=' + this.id,
