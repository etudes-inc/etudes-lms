/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/site-manage/site-manage-tool/tool/src/java/org/sakaiproject/site/tool/ImportOtherLMSMoodle.java $
 * $Id: ImportOtherLMSMoodle.java 3072 2012-07-12 16:40:11Z rashmim $
 ***********************************************************************************
 *
...
public class ImportOtherLMSMoodle2 extends BaseImportOtherLMS
{
	...
	public String transferEntities()
	{
		...
		if (eleModules != null)
		{
			for (Iterator<?> iter = eleModules.elementIterator("section"); iter.hasNext();)
			{
				...
				module_sections = buildMeleteModule(sectionElement, weekDates, module_sections, existingModules);
			}
		}
	 ...
	 */
	private HashMap<String, ModuleObjService> buildMeleteModule(Element sectionElement, List<CalculatedDates> weekDates, HashMap<String, ModuleObjService> module_sections,
			List<ModuleObjService> existingModules)
	{
		...
		if (number != null)
		{
			...
			ModuleObjService module = findOrAddModule(checkModuleTitle, 0, summaryText, startDate, endDate, allowUntil, existingModules, null, null, null);
