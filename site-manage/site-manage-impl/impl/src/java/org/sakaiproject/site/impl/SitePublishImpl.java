/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/site-manage/site-manage-impl/impl/src/java/org/sakaiproject/site/impl/SitePublishImpl.java $
 * $Id: SitePublishImpl.java 4863 2013-05-16 18:03:43Z mallikamt $
 ***********************************************************************************
 *
...
/**
 * <p>
 * SitePublishImpl is a class used when sites are meant to published at a future date
 * </p>
 */
public class SitePublishImpl implements ScheduledInvocationCommand
{
	...
	/**
	 * For ScheduledInvocationCommand, use a high (0 .. 1000) priority
	 */
	public Integer getPriority()
	{
		return Integer.valueOf(900);
	}

	/**
	 * Implementation of command pattern. Will be called by ScheduledInvocationManager
	 * for delayed site publishings
	 *
	 * @param opaqueContext
