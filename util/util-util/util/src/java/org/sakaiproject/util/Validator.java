/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/util/util-util/util/src/java/org/sakaiproject/util/Validator.java $
 * $Id: Validator.java 9139 2014-10-31 20:26:05Z ggolden $
 ***********************************************************************************
 *
...
public class Validator
{
	...
	public static String escapeResourceName(String id)
	{
		...
		try
		{
			...
			{
				char c = id.charAt(i);
				if (c < '\040')	// Remove any ascii control characters
				{
					buf.append('_');
				}
