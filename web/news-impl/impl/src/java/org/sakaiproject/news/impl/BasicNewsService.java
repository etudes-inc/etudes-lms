/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/web/news-impl/impl/src/java/org/sakaiproject/news/impl/BasicNewsService.java $
 * $Id: BasicNewsService.java 5896 2013-09-09 23:42:46Z ggolden $
 ***********************************************************************************
 *
							...
							if (toolConfs != null && !toolConfs.isEmpty())
							{
								for (ToolConfiguration config : toolConfs)
								{
									if (config.getToolId().equals(TOOL_ID))
									{
										...
										//Do not import items that already exist or if news url is null
										if (pageTitle != null && pageTitle.equals(p.getTitle()) && ((newsUrl != null
												&& newsUrl.equals(config.getPlacementConfig().getProperty(NEWS_URL_PROP)))||(newsUrl == null && config.getPlacementConfig().getProperty(NEWS_URL_PROP) == null)))
										{
											skip = true;
											break;
										}
