/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/calendar/calendar-api/api/src/java/org/sakaiproject/calendar/api/CalendarService.java $
 * $Id: CalendarService.java 1865 2011-07-27 00:09:51Z mallikamt $
 ***********************************************************************************
 *
	...
	extends EntityProducer
{
	...
	*/
	...
	/**
	 * Get the earliest start date of events from the db
	 * 
	 * @param course_id
	 *            The context(course id).
	 * @return If events exist, returns the earliest start
	 *         date, otherwise returns null.
	 */	
	public Date getMinStartDate(String course_id);
	
	/**
	 * Get the latest start date of events from the db
	 * 
	 * @param course_id
	 *            The context(course id).
	 * @return If events exist, returns the latest start
	 *         date, otherwise returns null.
	 */	
	public Date getMaxStartDate(String course_id);	

	/**
	 * Apply base date changes to start and end dates of this
	 * course's events
	 * 
	 * @param course_id
	 *            The context(course id).
