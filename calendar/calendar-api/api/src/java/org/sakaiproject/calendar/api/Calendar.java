/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/calendar/calendar-api/api/src/java/org/sakaiproject/calendar/api/Calendar.java $
 * $Id: Calendar.java 2906 2012-05-07 20:50:18Z ggolden $
 ***********************************************************************************
 *
	...
	extends Entity
{
    ...
    * @param own boolean flag indicating whether user owns event
	...
	/**
	 * Check for an event in the calendar that matches the key fields of this event
	 * 
	 * @param event
	 *        The event to check against.
	 * @return true if we find a close matching event, false if not.
	 */
	boolean containsMatchingEvent(CalendarEvent event);
