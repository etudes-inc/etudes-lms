/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/calendar/calendar-impl/impl/src/java/org/sakaiproject/calendar/impl/RecurrenceRuleBase.java $
 * $Id: RecurrenceRuleBase.java 2906 2012-05-07 20:50:18Z ggolden $
 ***********************************************************************************
 *
...
public abstract class RecurrenceRuleBase implements RecurrenceRule
{
	...
	*/
	...
	public boolean equals(Object obj)
	{
		...
		if (this.interval != ((RecurrenceRuleBase) obj).interval) return false;
		if (this.count != ((RecurrenceRuleBase) obj).count) return false;
		if (different(this.until, ((RecurrenceRuleBase) obj).until)) return false;
