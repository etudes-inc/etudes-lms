/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/calendar/calendar-summary-tool/tool/src/java/org/sakaiproject/tool/summarycalendar/ui/CalendarBean.java $
 * $Id: CalendarBean.java 5764 2013-08-29 17:19:35Z mallikamt $
 ***********************************************************************************
 *
...
public class CalendarBean extends InitializableBean implements Serializable {
	...
	public Map getEventImageMap() {
		if(eventImageMap == null || eventImageMap.size() == 0){
			...
			eventImageMap.put("Holiday", px + "holiday.gif");
