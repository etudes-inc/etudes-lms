/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/event/event-util/util/src/java/org/sakaiproject/util/EmailNotification.java $
 * $Id: EmailNotification.java 7422 2014-02-17 23:43:20Z ggolden $
 ***********************************************************************************
 *
...
public class EmailNotification implements NotificationAction
{
	...
	public void notify(Notification notification, Event event)
	{
		...
		if (immediate.size() > 0)
		{
			...
			String messageForImmediates = message + getTag(newline, title, siteId);
