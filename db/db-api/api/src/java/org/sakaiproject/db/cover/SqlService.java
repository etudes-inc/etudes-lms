/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/db/db-api/api/src/java/org/sakaiproject/db/cover/SqlService.java $
 * $Id: SqlService.java 2944 2012-05-23 15:40:17Z ggolden $
 ***********************************************************************************
 *
...
public class SqlService
{
	...
	public static org.sakaiproject.db.api.EmptyString newEmptyString()
	{
		org.sakaiproject.db.api.SqlService service = getInstance();
		if (service == null) return null;

		return service.newEmptyString();
	}
}
