/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/db/db-api/api/src/java/org/sakaiproject/db/api/SqlService.java $
 * $Id: SqlService.java 6079 2013-10-01 16:16:10Z ggolden $
 ***********************************************************************************
 *
...
public interface SqlService
{
	...
	/**
	 * Encode the boolean value for writing to the database
	 * 
	 * @param b
	 *        The value
	 * @return The database string
	 */
	String valueForBoolean(Boolean b);

	/**
	 * Encode the date value for writing to the database
	 * 
	 * @param b
	 *        The value
	 * @return The database string
	 */
	Long valueForDate(Date date);
	 ...
	 * @throws SQLException
	 */
	String readId(ResultSet result, int index) throws SQLException;
