/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/db/db-impl/impl/src/java/org/sakaiproject/db/impl/BasicSqlService.java $
 * $Id: BasicSqlService.java 8597 2014-08-31 20:55:03Z ggolden $
 ***********************************************************************************
 *
...
import org.sakaiproject.db.api.EmptyString;
...
public abstract class BasicSqlService implements SqlService
{
	...
	public class EmptyStringImpl implements EmptyString
	{
	}
		...
		if ((fields != null) && (fields.length > 0))
		{
			for (int i = 0; i < fields.length; i++)
			{
				...
				else
				{
					...
					// EmptyString support
					if (fields[i] instanceof EmptyString)
					{
						value = "";
					}
					else
					{
						value = fields[i].toString();
					}
	 ...
	 * {@inheritDoc}
	 */
	public EmptyString newEmptyString()
	{
		return new EmptyStringImpl();
	}
	 ...
	 * {@inheritDoc}
	 */
	public String valueForBoolean(Boolean b)
	{
	 ...
	 * {@inheritDoc}
	 */
	public Long valueForDate(Date d)
	{
	 ...
	 * {@inheritDoc}
	 */
	public String readId(ResultSet result, int index) throws SQLException
	{
