/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/presence/presence-api/api/src/java/org/sakaiproject/presence/api/PresenceService.java $
...
public interface PresenceService
{
	...
	/**
	 * Access a List of sessions (UsageSession) now present in locations that start with this id.
	 * 
	 * @param locationId
	 *        A presence location id root.
	 * @return The a List of sessions (UsageSession) now present in these location (may be empty).
	 */
	List getPresentUsersPartialId(String locationId);

	/**
	 * Get a count of the # sessions at this location.
	 * @param locationId The presence location id.
	 * @return the count of the # sessions at this location, or 0 if none.
	 */
	Integer countPresence(String locationId);
	 ...
	 */
	void checkPresenceForExpiration();
