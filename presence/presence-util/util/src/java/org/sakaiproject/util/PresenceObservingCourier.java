/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/presence/presence-util/util/src/java/org/sakaiproject/util/PresenceObservingCourier.java $
 * $Id: PresenceObservingCourier.java 8189 2014-06-08 00:56:34Z ggolden $
 ***********************************************************************************
 *
...
public class PresenceObservingCourier extends EventObservingCourier
{
	...
	public boolean check(Object arg)
	{
		...
		if (m_resourcePattern != null)
		{
			...
			// this is used exclusively for watching the chat presence, which now extends the tool id with the chat room.  We need an inexact match.
