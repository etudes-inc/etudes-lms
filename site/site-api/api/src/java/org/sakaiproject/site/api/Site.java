/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/site/site-api/api/src/java/org/sakaiproject/site/api/Site.java $
 * $Id: Site.java 7237 2014-01-22 22:14:17Z mallikamt $
 ***********************************************************************************
 *
...
public interface Site extends Edit, Comparable, Serializable, AuthzGroup
{
	...
	/**
	 * Check if this tool exists somewhere in the site.
	 * 
	 * @param commonToolId
	 *        The tool id (String, such as sakai.chat, not a tool configuration / placement uuid) to search for.
	 * @return true if the tool exists in the site, false if not.
	 */
	...
	/**
	 * Access the site's term suffix, as defined in the term tables.
	 * 
	 * @return The site's term suffix, or null if it has none (for project or dev or other non-term sites).
	 */
	String getTermSuffix();
	
	/**
	 * Access the site's term id, as defined in the term tables.
	 * 
	...
	/**
	 * Access the term description, which is translated using the term suffix
	 * 
	 * @return The site's term description.
	 */
	String getTermDescription();
	

	/**
	 * @return true if the user has established the site's skin, false if it is null or matching the site's template.
	 */
	boolean userEditedSkin();
	
	/**
	 * @return true if the user has established the site's info url, false if it is null or matching the site's template.
	 */
	boolean userEditedInfo();
	
	/**
	 * @return true if the user has established the site's publication or unpublication dates, false if not.
	 */
	boolean userEditedPubDates();
}
