/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/site/site-api/api/src/java/org/sakaiproject/site/cover/SiteService.java $
 * $Id: SiteService.java 9547 2014-12-16 04:30:32Z ggolden $
 ***********************************************************************************
 *
...
public class SiteService
{
	...
	public static void getOrderedSites(java.lang.String userId, java.util.List<org.sakaiproject.site.api.Site> visibleSites, java.util.List<org.sakaiproject.site.api.Site> hiddenSites)
	{
		org.sakaiproject.site.api.SiteService service = getInstance();
		if (service == null) return;

		service.getOrderedSites(userId, visibleSites, hiddenSites);
	}
	...
	public static org.sakaiproject.site.api.Site getSiteByTitle(java.lang.String param0) throws org.sakaiproject.exception.IdUnusedException
	{
		org.sakaiproject.site.api.SiteService service = getInstance();
		if (service == null) return null;

		return service.getSiteByTitle(param0);
	}

	public static org.sakaiproject.site.api.Site getTemplate(java.lang.String param0)
	{
		org.sakaiproject.site.api.SiteService service = getInstance();
		if (service == null) return null;

		return service.getTemplate(param0);
	}
	
	public static Long getSiteTermId(java.lang.String param0)
	{
		org.sakaiproject.site.api.SiteService service = getInstance();
		if (service == null) return null;

		return service.getSiteTermId(param0);
	}
}
