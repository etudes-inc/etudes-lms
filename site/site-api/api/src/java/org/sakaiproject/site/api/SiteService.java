/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/site/site-api/api/src/java/org/sakaiproject/site/api/SiteService.java $
 * $Id: SiteService.java 9527 2014-12-12 23:09:51Z ggolden $
 ***********************************************************************************
 *
...
public interface SiteService extends EntityProducer
{
	...
	/** Name for the permission for observing a site. */
	static final String SITE_OBSERVER = "site.observer";
	...
	public class SelectionType
	{
		...
		/** Get sites that the current user has some access to, even if not published (non-myWorkspace, non-special). */
		public static final SelectionType MYSITES = new SelectionType("mysites", true, true, false);
		...
		public static final SelectionType PUBVIEW = new SelectionType("pubView", true, true, false);
	...
	public class SortType
	{
		...
		/** Sort on term by ASC */
		public static final SortType TERM_ASC = new SortType("term", true);

		/** Sort on term by DESC */
		public static final SortType TERM_DESC = new SortType("term", false);
	 ...
	 *        Additional selection criteria: sites returned will have a property named to match each key in the map, whose values match (somewhere in their value) the value in the map (may be null or empty).
	 * @param term
	 *        If not null, limit to sites in this term (term is the numeric term code).
	 * @param instPrefix
	 ...
	 */
	List getSites(SelectionType type, Object ofType, String criteria, Integer term, String instPrefix, Map propertyCriteria, SortType sort,
			PagingPosition page);
	 ...
	 */
	int countSites(SelectionType type, Object ofType, String criteria, Integer term, String instPrefix, Map propertyCriteria);
	...
	/**
	 * Get a site by its title.
	 * 
	 * @param title
	 *        The site title.
	 * @return The site.
	 * @throws IdUnusedException
	 *         if there is no site by this title.
	 */
	Site getSiteByTitle(String title) throws IdUnusedException;

	/**
	 * Get the template for a site with this title.
	 * 
	 * @param title
	 *        The site title.
	 * @return The site template, or null if there is none.
	 */
	Site getTemplate(String title);

	/**
	 * Access the institution code for the given site.
	 * 
	 * @param siteId
	 *        The site's id.
	 * @return The institution code for the site, or null if the site or the code is not found.
	 */
	String getInstitutionCode(String siteId);
	 ...
	 */
	void getOrderedSites(String userId, List<Site> visibleSites, List<Site> hiddenSites);

	/**
	 * Lookup the term id for this site.
	 * 
	 * @param siteId
	 *        The site id.
	 * @return The term id if found, null if not.
	 */
	Long getSiteTermId(String siteId);
}
