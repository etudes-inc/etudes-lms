/**********************************************************************************
 * $URL: https://source.etudes.org/svn/etudes/source/trunk/tool/tool-api/api/src/java/org/sakaiproject/tool/api/Tool.java $
...
public interface Tool
{
	...
	/**
	 * @return "Sakai" for Sakai tool style dispatching, "E3" for E3 tool style dispatching.
	 */
	String getDispatcherStyle();

	/**
	 * @return the url root for E3 dispatching.
	 */
	String getE3Path();

	/**
	 * @return the html resource name for E3 dispatching.
	 */
	String getE3Code();
